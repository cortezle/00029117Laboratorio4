...
enum parameters {ELEMENT_LENGTH,CONS_T,CONST_K,LAMBDA,CONS_UVE,PSI,ALFA,DELTA,CONS_N};
...
class mesh{
    ...
    public:
        void setParameters(float l,float t,float k,float lambda,float uve,float psi,float alfa,float delta,float n){
                parameters[ELEMENT_LENGTH]=l;
                parameters[CONS_T]=t;
                parameters[CONST_K]=k;
                parameters[LAMBDA]=lambda;
                parameters[CONS_UVE]=uve;
                parameters[PSI]=psi;
